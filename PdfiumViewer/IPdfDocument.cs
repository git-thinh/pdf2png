...
namespace PdfiumViewer
{
    ...
    public interface IPdfDocument : IDisposable
    {
        ...
        Image RenderTransparentBG(int page, int width, int height, float dpiX, float dpiY);
        ...
        /// <param name="flags">Flags used to influence the rendering.</param>
        /// <returns>The rendered image.</returns>
        Image Render(int page, int width, int height, float dpiX, float dpiY, PdfRotation rotate, PdfRenderFlags flags, bool transparentBG = false);
